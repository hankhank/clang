...
template <> struct MappingTraits<FormatStyle> {
  static void mapping(IO &IO, FormatStyle &Style) {
    ...
    IO.mapOptional("NamespaceOnSingleLine", Style.NamespaceOnSingleLine);
...
template <> struct MappingTraits<FormatStyle::BraceWrappingFlags> {
  static void mapping(IO &IO, FormatStyle::BraceWrappingFlags &Wrapping) {
    ...
    IO.mapOptional("AfterIfElse", Wrapping.AfterIfElse);
...
FormatStyle getLLVMStyle() {
  ...
  LLVMStyle.InheritanceAllOnOneLineOrOnePerLine = true;
...
FormatStyle getGoogleStyle(FormatStyle::LanguageKind Language) {
  ...
  GoogleStyle.InheritanceAllOnOneLineOrOnePerLine = true;
